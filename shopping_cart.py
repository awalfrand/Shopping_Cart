...
while True:
    product_id = input("Please enter a Product ID, or enter 'DONE' if there are no more items: ")
    if product_id == "DONE":
        break
    else:
...
print("-------")
print("Il Supermercato")
print("-------")
print("Web: www.ilsupermercato.com")
print("Phone: 1.716.435.9634")
...
for product_id in product_ids:
    ...
    price_formatted = ' (${0:.2f})'.format(product["price"])
    print(" + " + product["name"] + price_formatted)

print("-------")
print("Subtotal:", '${0:.2f}'.format(running_total))
tax = running_total * 0.08875
print("New York Sales Tax (8.875%):", '${0:.2f}'.format(tax))
total = running_total + tax
print("Total:", '${0:.2f}'.format(total))

print("-------")
print("Grazie per il tuo supporto commerciale! Vi auguro una buona giornata!")
